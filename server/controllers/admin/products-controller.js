...
const handleImageUpload = async (req, res) => {
    try {
        ...
        console.log(error);
        res.json({ success: false, message: "Error Image Upload" });
    }
}
...
const addProduct = async (req, res) => {
    try {
        ...
        res.status(201).json({ success: true, message: "Product added successfully", data: newCreatedProduct });
...
const fetchAllProduct = async (req, res) => {
    try {
        ...
        console.log(error);
        res.json({ success: false, message: "Error Fetched" });
    }
}
